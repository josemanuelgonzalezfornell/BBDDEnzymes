...
def ExportAll():
    ...
    myCursor.close()
    conection.close()
    header = ["ID", "NOMBRE_ENZIMA", "MICROORGANISMO_PROCEDENCIA", "TIPO_ENZYMA", "VECTOR", "pH_OPTIMO", "ACTIVIDAD", "SUSTRATO_ESPECIFICO", "TIPO_AJUSTE_CINETICO", "INTRACELULAR_EXTRACELULAR", "SOLUBLE_CUERPOS", "PROTOCOLO_PURIFICACION", "PROTOCOLO_REPLIEGUE", "TAMAÑO", "PESO_MOLECULAR", "TEMPERATURA_OPTIMA_EXPRESION",
    ...
    with open(filedialog.asksaveasfile(title="Guardar", initialdir="/"), 'w', newline='') as csvfile:
...
def ExportSearched(id, name, microrganism, type, vector, ph, activity, substrate, adjustmenttype, intraextracellular, soluble, protocolpurification, protocolreplegament, aa, mw, temperatureexpression, temperatureactivity, pi, iptg, coefficient, timeexpression, km, kmunit, kmerror, kcat, kcatunit, kcaterror, kmkcat, kmkcatunit, kmkcaterror, seqdnatext, seqaatext, commentstext, root):
    searchInstance(id, name, microrganism, type, vector, ph, activity, substrate, adjustmenttype, intraextracellular, soluble, protocolpurification, protocolreplegament, aa, mw, temperatureexpression,
                   temperatureactivity, pi, iptg, coefficient, timeexpression, km, kmunit, kmerror, kcat, kcatunit, kcaterror, kmkcat, kmkcatunit, kmkcaterror, seqdnatext, seqaatext, commentstext, root)
    datatoexport = confirmation = messagebox.askquestion(
        "Exportar", "¿Desea exportar el resultado de esta búsqueda?")
    if confirmation == "yes":
        header = ["ID", "NOMBRE_ENZIMA", "MICROORGANISMO_PROCEDENCIA", "TIPO_ENZYMA", "VECTOR", "pH_OPTIMO", "ACTIVIDAD", "SUSTRATO_ESPECIFICO", "TIPO_AJUSTE_CINETICO", "INTRACELULAR_EXTRACELULAR", "SOLUBLE_CUERPOS", "PROTOCOLO_PURIFICACION", "PROTOCOLO_REPLIEGUE", "TAMAÑO", "PESO_MOLECULAR", "TEMPERATURA_OPTIMA_EXPRESION",
                  "TEMPERATURA_OPTIMA_ACTIVIDAD", "PUNTO_ISOELECTRICO", "CONCENTRACION_IPTG_mM", "COEF_EXTINCION_MOLAR", "TIEMPO_EXPRESION_h", "Km", "UNIDAD_Km", "ERROR_ESTANDAR_Km", "Kcat", "UNIDAD_Kcat", "ERROR_ESTANDAR_Kcat", "KmKcat", "UNIDAD_KmKcat", "ERROR_ESTANDAR_KmKcat", "SECUENCIA_DNA", "SECUENCIA_AA", "COMENTARIOS"]
        with open(filedialog.asksaveasfile(title="Guardar", initialdir="/"), 'w', newline='') as csvfile:
