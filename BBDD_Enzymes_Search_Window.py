...
def openSearchWindow(root):
	...
	while True:
		try:
			...
			commentstext.grid(row=14, column=5, sticky=W, columnspan=9, rowspan=2)
			...
			searchbutton=Button(bottomframe, text="Buscar", width=15, command=lambda:searchInstance(id,name, microrganism, type, vector, ph, activity, substrate, adjustmenttype, intraextracellular, soluble, protocolpurification, protocolreplegament, aa, mw, temperatureexpression, temperatureactivity, pi, iptg, coefficient, timeexpression, km, kmunit, kmerror, kcat, kcatunit, kcaterror, kmkcat, kmkcatunit, kmkcaterror, seqdnatext, seqaatext, commentstext, root))
			...
			actionmenu.add_command(label="Buscar", command=lambda:searchInstance(id,name, microrganism, type, vector, ph, activity, substrate, adjustmenttype, intraextracellular, soluble, protocolpurification, protocolreplegament, aa, mw, temperatureexpression, temperatureactivity, pi, iptg, coefficient, timeexpression, km, kmunit, kmerror, kcat, kcatunit, kcaterror, kmkcat, kmkcatunit, kmkcaterror, seqdnatext, seqaatext, commentstext, root))
